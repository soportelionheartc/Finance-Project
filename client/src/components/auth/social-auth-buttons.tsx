    ...
    <>
      <div className="grid grid-cols-2 gap-3">
        <Button
          ...
          className="flex items-center justify-center gap-2 border-zinc-700 bg-black text-white hover:bg-zinc-900"
        >
      ...
      <div className="mt-3 grid grid-cols-2 gap-3">
        <Button
          ...
          disabled={socialLoginMutation.isPending}
          className="flex items-center justify-center gap-2 border-purple-600/30 bg-black text-purple-400 hover:bg-purple-900/10"
        >
        ...
        <Button
          ...
          disabled={socialLoginMutation.isPending}
          className="flex items-center justify-center gap-2 border-blue-600/30 bg-black text-blue-400 hover:bg-blue-900/10"
        >
