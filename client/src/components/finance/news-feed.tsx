  ...
  const newsItems: NewsItem[] = [
    {
      ...
      summary: "La principal criptomoneda continúa su tendencia alcista en medio de una creciente adopción institucional.",
    ...
    },
    {
      ...
      summary: "La petrolera colombiana confirmó un hallazgo significativo que podría aumentar las reservas nacionales.",
    ...
    },
    {
      ...
      summary: "El banco central de EE.UU. decidió mantener las tasas en su nivel actual, señalando preocupaciones sobre la inflación.",
    ...
    },
    {
      ...
      summary: "La compañía de Cupertino reveló productos con capacidades avanzadas de inteligencia artificial.",
