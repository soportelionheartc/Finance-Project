    ...
    const mockMessages: Message[] = [
      {
        ...
        content:
          "¿Cuál es su opinión sobre la tendencia actual de ETH? El análisis técnico muestra un patrón de bandera alcista que podría impulsar los precios a nuevos máximos.",
      ...
      },
      {
        ...
        content:
          "He notado que hay varias noticias positivas sobre la adopción institucional de BTC. ¿Alguien más está siguiendo estos desarrollos?",
      ...
      },
      {
        ...
        content:
          "Buenos días a todos. ¿Qué opinan de las acciones de tecnología en Colombia? ¿Hay alguna empresa que esté en su radar para inversión?",
      ...
      },
      {
        ...
        senderName: "Trader_Eth",
        content:
          "He estado analizando algunas estrategias de DeFi y creo que hay oportunidades interesantes en protocolos de préstamo con tasas superiores al 8% APY.",
      ...
      },
      {
        ...
        content:
          "¿Alguien tiene experiencia con el mercado bursátil colombiano? Estoy interesado en diversificar mi portafolio más allá de las criptomonedas.",
      ...
      },
      {
        ...
        senderName: "SolanaTrader",
        content:
          "Buenos días comunidad, he estado siguiendo las noticias sobre la regulación de criptomonedas en Colombia. Parece que estamos en un momento crucial para la adopción.",
    ...
    if (message.trim() && selectedWallet) {
      ...
      setTimeout(() => {
        const newMessage: Message = {
          ...
          topic,
          chainId:
            wallets.find((w) => w.address === selectedWallet)?.type ||
            "ethereum",
        };
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="mb-6 flex flex-col space-y-2">
          ...
          <p className="text-muted-foreground">
            Conecta con otros traders y discute sobre blockchain, finanzas e
            inversiones
          </p>
        </div>
            ...
            <div className="space-y-4 md:w-1/4">
              <Card className="border-zinc-800 bg-zinc-900">
                ...
                <CardContent className="p-0">
                  <TabsList className="grid h-auto w-full grid-cols-1 bg-transparent px-2 py-1">
                    <TabsTrigger
                      value="all"
                    ...
                    <TabsTrigger value="defi" className="w-full justify-start">
            ...
            <div className="md:w-3/4">
              <Card className="flex h-[600px] flex-col border-zinc-800 bg-zinc-900">
                <CardHeader>
                  ...
                  <CardDescription>
                    Todo mensaje es almacenado de forma descentralizada en la
                    blockchain seleccionada
                  </CardDescription>
                </CardHeader>

                <TabsContent value="all" className="grow overflow-y-auto p-4">
                      ...
                      <div key={msg.id} className="flex flex-col space-y-1">
                        <div className="flex items-start space-x-2">
                          <Avatar className="mt-1 h-8 w-8">
                            <AvatarFallback
                              className={`${getChainColor(msg.chainId).split(" ")[0]}`}
                            >
                              {msg.senderName?.slice(0, 2).toUpperCase() ||
                                msg.senderAddress.slice(0, 2)}
                            </AvatarFallback>
                          </Avatar>
                          <div className="flex-1 rounded-lg bg-zinc-800 p-3">
                            <div className="mb-1 flex items-center justify-between">
                              <div className="flex items-center">
                                <h4 className="mr-2 text-sm font-medium">
                                  {msg.senderName ||
                                    formatAddress(msg.senderAddress)}
                                </h4>
                                <Badge
                                  className={`${getChainColor(msg.chainId)} text-xs`}
                                >
                ...
                <TabsContent value="defi" className="grow overflow-y-auto p-4">
                  <div className="space-y-4">
                  ...
                  <div className="grid w-full grid-cols-12 gap-2">
                    ...
                    <div className="col-span-7">
                      <Input
                        placeholder={
                          selectedWallet
                            ? "Escribe tu mensaje..."
                            : "Conecta una wallet para enviar mensajes"
                        }
                        value={message}
                    ...
                    <div className="col-span-2">
                      <Button
                        ...
                        disabled={
                          !selectedWallet || isLoading || !message.trim()
                        }
