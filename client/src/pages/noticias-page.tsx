      ...
      const mockNewsItems: NewsItem[] = [
        {
          ...
          summary:
            "La Reserva Federal de Estados Unidos decidió mantener las tasas de interés sin cambios en su última reunión, en línea con las expectativas del mercado.",
        ...
        },
        {
          ...
          summary:
            "La principal criptomoneda superó los $100,000 por primera vez en su historia, impulsada por la aprobación de nuevos ETFs y la adopción institucional.",
        ...
        },
        {
          ...
          summary:
            "El indicador RSI del índice S&P 500 muestra niveles de sobrecompra que podrían anticipar una corrección en el corto plazo.",
        ...
        },
        {
          ...
          summary:
            "El gobierno chino anunció un paquete de estímulos económicos de $1.2 billones para impulsar su economía en medio de la desaceleración del crecimiento.",
        ...
        },
        {
          ...
          summary:
            "Las acciones de Apple subieron un 8% después de reportar resultados que superaron las expectativas de Wall Street, impulsados por ventas récord del iPhone 16.",
          category: "Acciones",
        ...
        },
        {
          ...
          summary:
            "Expertos recomiendan diversificar portafolios con activos reales como commodities y REITS para protegerse contra la inflación persistente.",
    ...
    <div className="bg-background min-h-screen">
        ...
        <div className="container mx-auto flex items-center justify-between">
          <Link href="/">
            <div className="flex cursor-pointer items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold">LION HEART CAPITAL</h1>
              </div>
            </div>
          </Link>
          <Link href="/auth">
      ...
      <main className="container mx-auto max-w-6xl px-4 py-6">
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          <Badge
            className={`cursor-pointer px-3 py-1 ${selectedCategory === "Todas" ? "text-primary border-primary/30 bg-black" : "border border-zinc-700 bg-black"}`}
            onClick={() => setSelectedCategory("Todas")}
          >
            Todas
          </Badge>
          {categories.map((category) => (
            <Badge
              key={category}
              className={`cursor-pointer px-3 py-1 ${selectedCategory === category ? "text-primary border-primary/30 bg-black" : "border border-zinc-700 bg-black"}`}
              ...
              >
                <CardContent className="p-0">
                  <div className="flex h-40 items-center justify-center bg-black">
                    <TrendingUp className="text-primary/50 h-16 w-16" />
                  </div>
                  <div className="relative space-y-2 p-4">
                    {news.premium && (
                      <Badge className="text-primary border-primary/50 absolute top-4 right-4 bg-black">
                        Premium
                      </Badge>
                    )}
                    ...
                    <Badge
                      variant="outline"
                      className="border-primary/30 text-primary bg-black"
                    >
                      {news.category}
                    </Badge>
                        ...
                        {news.premium ? (
                          <Link href="/auth">
                            <Button
                              variant="ghost"
                              size="icon"
                              className="hover:text-primary hover:bg-primary/10 h-6 w-6 rounded-full"
                            >
        ...
        {/* Llamada a la acción */}
        <Card className="border-primary/30 mt-8 border bg-black">
          <CardContent className="p-6 md:p-8">
            <div className="grid items-center gap-6 md:grid-cols-2">
              ...
              <div className="flex justify-center">
                <div className="border-primary/20 rounded-full border bg-black/50 p-8">
      ...
      {/* Footer */}
      <footer className="mt-8 border-t border-zinc-800 p-6 text-center text-sm text-gray-400">
        <div className="container mx-auto">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div>
              <p className="text-primary font-medium">Zupi Fintech</p>
              <p className="mt-2">Contacto: lionheartcapital1303@gmail.com</p>
            </div>

            <div className="space-y-4">
              <p className="text-primary font-medium">Síguenos</p>
