...
- Posiblemente tambien los titulos en dorado de la seccion explorar servicios o añadirle un margen a la izquierda.
...
- En el panel de administración, en la seccion de Usuarios implementar los filtros adecuados, y funcionalidad de insertar nuevos usuarios, ademas se podria añadir la funcionalidad de eliminar usuarios ya que hace parte de los roles de administrador.

- Funcionalidades generales de Sistema y Reportes en Panel de Administracion.

- Rspecto al usuario revisar las opciones de Panel de Admin, Perfil, Configuracion.
